/**
 * Detalhe do Paciente — /dashboard/pacientes/[id]
 */
...
import { PacienteDetalhe } from '@/features/pacientes/components/PacienteDetalhe'
import type { PacienteData, PacienteEndereco } from '@/features/pacientes/types/paciente.types'

export const metadata: Metadata = {
  title: 'Paciente | OdontoSystem',
}
...
export default async function PacienteDetalhePage({ params }: Props) {
  ...
  return <PacienteDetalhe paciente={paciente} />
}
