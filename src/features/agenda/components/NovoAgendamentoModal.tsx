/**
 * NovoAgendamentoModal — formulário de criação de agendamento
 */
'use client'
...
import { agendamentoSchema, agendamentoDefaultValues } from '../validations/agendamento.schemas'
import type { AgendamentoFormValues } from '../validations/agendamento.schemas'
import type { DentistaOption, PacienteOption, ProcedimentoOption } from '../types/agenda.types'
import { AGENDAMENTO_STATUS, STATUS_LABELS } from '../types/agenda.types'
...
export function NovoAgendamentoModal({
  ...
  // Preenche valores iniciais quando abre
  useEffect(() => {
    if (open) {
      reset({
        ...agendamentoDefaultValues,
        data: initialData?.data ?? '',
        hora: initialData?.hora ?? '',
        dentista_id: initialData?.dentistaId ?? '',
      })
      setPacienteNome('')
      setPacienteSearch('')
      setPacienteOptions([])
  ...
  // Preenche duração ao selecionar procedimento
  useEffect(() => {
    if (procedimentoId) {
